...
public class DuDuNiuTest {

	@Test
	public void inserts() throws Exception {
		String path = "/home/aoeng/Study/databases/all-db/duduniu/d-REYE_txt.";
		for (int i = 1; i < 18; i++) {
			insert(path + i);
		}
	...
	public void insert(String path) throws Exception {
		...
		String sql = "insert into tb_duduniu(uname,pwd,email,md5,sha1) values(?,?,?,?,?)";
